...
/* Trying different ways to get it over.
    ...
    b1.onClick = function(){goIn()};
    document.getElementById("choices").appendChild(b1);

    var b2 = document.createElement("BUTTON");
    var b2Text = document.createTextNode("Leave");
...
var leave = function(){
  ...
  var text = "You gained 1000 points for making a good life decision. You go home and spend the night watching Netflix and eating pizza. No matter how many mocking texts your friends send you, you know nothing is better than the Netflix and chill option in life.  At least you’ll always have your Facebook friends… The End. You finished with a score of " + score;
...
var runAway = function (){
  ...
  var text = "	In such a rush to leave you run into a door and are knocked out. You awake in the morning to find that you survived a night in the haunted house, but are now covered in unmentionable markings. Some great friends you have there. The End. You finished with a final score of " + score;
...
var danceLose = function(){
  ...
  var text = "I’ve never seen something flail about aimless that much in my life. Fortunately, you won’t have much room to dance pathetically once you’re in my stomach.- The Wolf Said.  You always knew you should’ve taken a dance class instead of spending so much time on the computer. At least you don’t have too much time left to worry about it or your paltry score of " + score;
...
var dracVanOld = function(playerChoice){
  ...
  //Use random number generator to determine vampire choice
...
var dracWin = function(vampChoice){
  ...
  var text = "The vampire selected " + vampChoice + " and you won! Supremely impressed by your uncanny intellect the vampire decides to suck your blood anyway to absorb all that knowledge. It's a shame really because you could've written such good Twilight Fan-Fic about it... The end. You finished with a score of " + score;
...
var dracLoss = function(vampChoice){
  ...
  var text = "The vampire selected " + vampChoice + " and you lost! Disgusted by your lack of ingenuity, the vampire decides it would be best if there wasn't an immortal version of you and spares you. Screaming like a mad man, you run home and never sleep well again. The End. You finished with a score of " + score;
...
var dracTie = function(vampChoice){
    ...
    var text = "The vampire selected " + vampChoice + " and you tied! Having met his intellectual equal, the vampire decides make you immortal so you can be best buds and drink blood beers while watching bloodball or whatever it is vampire bros do. The End. You finished with a score of  " + score;
